...
document.addEventListener("DOMContentLoaded", function () {
    ...
    initCancelConfirmation({
        formSelector: '#create_blog_post',
        cancelBtnSelector: '.btn-outline-secondary',
        modalId: 'cancelModal'
    });

    initBlogDropzone(false);
    initPasteSupport();

    initAjaxFormValidation("#create_blog_post", {
        title: { required: true },
        ...
        beforeSubmit: function () {
            ...
            appendDropzoneFilesToForm('create_blog_post');
