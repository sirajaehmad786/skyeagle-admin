        ...
        <div class="col-12">
            <div class="page-title-box">
                <div class="page-title-right">
                    <button type="button" class="btn btn-primary btn-sm me-1 position-relative" data-bs-toggle="modal" data-bs-target="#filter_blog_comment_modal">
...
@section('script')
    <script>
        ...
        window.blogCommentApprovalUrl = "{{ url('blog-comments') }}";
    </script>
    @vite([
