@extends('crm.layouts.vertical', ['page_title' => 'Edit Blog Post'])
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="m-0 pt-3">Edit Blog Post</h4>
    ...
    <form id="update_blog_post" action="{{ route('blog-posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" value="{{ $post->title }}" placeholder="Blog Title">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" id="published_at" name="published_at" class="form-control" value="{{ $post->published_at ? $post->published_at->format('d-m-Y') : '' }}" autocomplete="off">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="mb-3">
                            <label class="form-label">Reading Time (Minutes)</label>
                            <input type="number" name="reading_time_minutes" class="form-control" min="1" step="1" value="{{ $post->reading_time_minutes }}">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="is_featured" name="is_featured" value="1" @checked($post->is_featured)>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea name="excerpt" class="form-control" rows="3" placeholder="Short excerpt">{{ $post->excerpt }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="mb-3">
                        ...
                        <div class="blog-author-panel mb-3">
                            ...
                            <div class="row align-items-start">
                                <div class="col-lg-3 col-md-4">
                                    ...
                                    <button type="button" class="btn btn-outline-danger btn-sm w-100 mt-2 {{ $post->author_image ? '' : 'd-none' }}" id="removeAuthorImage">
                                ...
                                <div class="col-lg-9 col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="author_name" class="form-control" value="{{ $post->author_name }}" placeholder="Author name">
                                    </div>
                                    <div class="mb-0">
                                        <label class="form-label">About Author</label>
                                        <textarea name="author_about" class="form-control" rows="5" placeholder="Short author bio shown below the blog post">{{ $post->author_about }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="dropzone" id="demoDropzone">
                                    ...
                                    <input type="hidden" id="existingImages" value='@json($post->images)'>
