@extends('crm.layouts.vertical', ['page_title' => 'Blog Posts', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('content')
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <button type="button" class="btn btn-primary btn-sm me-1 position-relative" data-bs-toggle="modal" data-bs-target="#filter_blog_post_modal">
                        ...
                        <a href="{{ route('blog-posts.create') }}" class="btn btn-primary btn-sm me-1">
                            Add Blog Post
                        </a>
                    </div>
                    <h4 class="m-0 pt-3">Blog Posts</h4>
    ...
    <div class="modal fade" id="filter_blog_post_modal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Filter Blog Posts</h5>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select id="filter_category_id" class="form-control filter-select">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select id="filter_tag_id" class="form-control filter-select">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select id="filter_is_featured" class="form-control filter-select">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" id="filter_published_from" class="form-control filter-date" placeholder="Published From">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label">Published To</label>
                                <input type="text" id="filter_published_to" class="form-control filter-date" placeholder="Published To">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
...
@section('script')
    <script>
        const ajaxUrl = "{{ route('blog-posts.index') }}";
        window.blogPostInlineUrl = "{{ url('blog-posts') }}";
        window.blogPostCategorySearchUrl = "{{ route('category.search') }}";
        window.blogPostStatuses = @json(collect($statuses)->map(fn($status) => ['id' => $status, 'text' => $status])->values());
    </script>
    @vite([
