@extends('crm.layouts.vertical', ['page_title' => 'Edit Category', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="m-0 pt-3">Edit Category</h4>
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="update_category_fr" action="{{ route('category.update', $category->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
...
@endsection
@section('script')
    @vite(['resources/js/crm/category/edit.js'])
@endsection