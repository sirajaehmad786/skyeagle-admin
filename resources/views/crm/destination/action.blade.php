<td class="text-center">
    <div class="btn-group dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end">
            <a class="dropdown-item text-primary" href="{{ route('destinations.edit', $row->id) }}">
                <i class="ri-edit-box-line me-2 text-muted vertical-middle"></i> Edit
            </a>
            <a class="dropdown-item text-danger delete-btn" href="{{ route('destinations.destroy', $row->id) }}" data-id="{{ $row->id }}">
