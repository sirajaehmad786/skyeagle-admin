@extends('crm.layouts.vertical', ['page_title' => 'Enquiry', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <button type="button" class="btn btn-primary btn-sm me-1 position-relative"
                            data-bs-toggle="modal" data-bs-target="#filter_enquiry_modal">
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-end align-items-center mb-3">
                        <div style="max-width: 300px; width: 100%;">
                            <input type="text" id="enquirySearch" class="form-control" placeholder="Search...">
                        </div>
                    </div>         
                        <div class="row">
                            <div class="col-lg-12 col-md-12">
                                <div class="table-responsive-scroll">
                                    <x-table id="enquiry-table">
                                        <tr>
                                            <th>Name</th>
                                            <th>Email</th>
                                            <th>Phone</th>
    ...
    @include('crm.enquiry.modal');
    <div class="modal fade" id="filter_enquiry_modal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Filter Enquiry</h5>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select id="filter_source" class="form-control filter-select">
                                    <option value="">All Sources</option>
                                    @foreach($sources as $source)
                                        <option value="{{ $source }}">{{ \Illuminate\Support\Str::headline($source) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
...
@section('script')
<script>
    let ajaxUrl = "{{ route('enquiry.index') }}";
</script>
    @vite([
