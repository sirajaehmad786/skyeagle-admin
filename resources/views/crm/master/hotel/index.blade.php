@extends('crm.layouts.vertical', ['page_title' => 'Hotels', 'mode' => $mode ?? '', 'demo' => $demo ?? '']) @section('css')
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <a href="{{ route('hotels.create') }}" class="btn btn-primary btn-sm">Add Hotel</a>
                    </div>
                    <h4 class="m-0 pt-3">Hotels</h4>
...
@section('script')
    <script>
        const ajaxUrl = "{{ route('hotels.index') }}";
        const deleteRecord = "{{ route('hotels.destroy', ':id') }}";
    </script> @vite(['resources/js/pages/demo.datatable-init.js', 'resources/js/pages/demo.form-advanced.js', 'resources/js/crm/hotel/index.js'])
@endsection
