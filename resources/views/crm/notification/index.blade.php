@extends('crm.layouts.vertical', ['page_title' => 'Notification', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
...
@section('script')
    <script>
       const notificationAjaxUrl = "{{ route('notifications.index') }}";
    </script>
    @vite([
