@extends('crm.layouts.vertical', ['page_title' => 'Quotations', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="m-0 pt-3">Quotations</h4>
...
@section('script')
    <script>
        const ajaxUrl = "{{ route('quotations.index') }}";
        const deleteRecord = "{{ route('quotations.destroy', ':id') }}";
        const quotationsByLeadUrl = "{{ route('quotations.byLead', ':id') }}";
    </script>    
