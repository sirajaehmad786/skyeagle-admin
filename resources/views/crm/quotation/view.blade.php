@extends('crm.layouts.vertical', ['page_title' => 'Quotation Details', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
@section('css')
...
@section('content')
    <div class="container-fluid">
        <div class="page-title-box d-flex justify-content-between align-items-center">
            <div>
                <h4 class="m-0 pt-3">Quotation Details</h4>
            ...
            <div class="page-title-right">
                    ...
                    <!-- <a href="{{ route('booking.exportbookingPdf', ['lead_id'=>$lead->id, 'quotation_id'=>$quotation->id]) }}" 
                    class="btn btn-success">
                        <i class="ri-file-pdf-line"></i> Booking Confirm
                    </a> -->

                @can('payment-history')
                    {{-- <button data-history_url="{{ route('payment.history') }}" class="btn btn-primary openPaymentHistory" data-booking_id="{{ $booking_id ?? '' }}">
                        <i class=""></i> Payment History
                    </button> --}}
                @endcan
            </div>
        </div>
        ...
        <div class="card mt-4 shadow-sm">
            <div class="card-body">
                <h5 class="pb-2 text-info">
                    <span class="border-bottom border-info">Quotation Price</span>
                </h5>
