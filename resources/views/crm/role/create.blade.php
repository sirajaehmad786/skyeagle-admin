@extends('crm.layouts.vertical', ['page_title' => 'Create Role', 'mode' => $mode ?? '', 'demo' => $demo ?? ''])
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="m-0 pt-3">Create Role</h4>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form id="create_role" action="{{ route('roles.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="level" name="level" class="form-control">
                                            ...
                                            @foreach(config('constant.role_level') as $role_level)
                                                <option value="{{$role_level}}">{{$role_level}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
