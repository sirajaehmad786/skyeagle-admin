...
@section('content')
            ...
            <div class="col-12">
                <div class="page-title-box">
                    <div class="page-title-right">
                        <button type="button" class="btn btn-primary btn-sm me-1 position-relative" data-bs-toggle="modal" data-bs-target="#filter_newsletter_subscriber_modal">
    ...
    <div class="modal fade" id="filter_newsletter_subscriber_modal" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Filter Newsletter Subscribers</h5>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select id="filter_subscription_status" class="form-control filter-select">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label">Subscribed From</label>
                                <input type="text" id="filter_subscribed_from" class="form-control filter-date" placeholder="Subscribed From">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label">Subscribed To</label>
                                <input type="text" id="filter_subscribed_to" class="form-control filter-date" placeholder="Subscribed To">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
